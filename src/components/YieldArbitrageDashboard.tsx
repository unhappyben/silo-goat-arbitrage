...
const TOKENS = {
  ...
  gmETH: formatTokenAddress('arbitrum', '0xfB3264D1129824933a52374c2C1696F4470D041e'),
  weETH: formatTokenAddress('arbitrum', '0x35751007a407ca6FEFfE80b3cB397736D2cf4dbe'),
  ezETH: formatTokenAddress('arbitrum', '0x2416092f143378750bb29b79eD961ab195CcEea5'),
  ...
  wstETH: formatTokenAddress('arbitrum', '0x5979D7b546E38E414F7E9822514be443A4800529'),
  ...
  'ETH+': formatTokenAddress('arbitrum', '0x18C14C2D707b2212e17d1579789Fc06010cfca23'),
  ...
  RETH: formatTokenAddress('arbitrum', '0xEC70Dcb4A1EFa46b8F2D97C310C9c4790ba5ffA8'),
  'wUSD+': formatTokenAddress('arbitrum', '0xB86fb1047A955C0186c77ff6263819b37B32440D'),
  ...
  uniETH: formatTokenAddress('arbitrum', '0x3d15fD46CE9e551498328B1C83071D9509E2C3a0'),
  ...
  wUSDM: formatTokenAddress('arbitrum', '0x57F5E098CaD7A3D1Eed53991D4d66C45C9AF7812'),
  stEUR: formatTokenAddress('arbitrum', '0x004626A008B1aCdC4c74ab51644093b155e59A23'),
  JOE: formatTokenAddress('arbitrum', '0xf57f2cCbB30c3C5ea982F21195df435d179d6b48'),
  DLCBTC: formatTokenAddress('arbitrum', '0x050C24dBf1eEc17babE5fc585F06116A259CC77A'),
  ...
  const fetchTokenPrice = async (tokenKey: string) => {
    try {
      ...
      if (price) {
        ...
        console.warn(`No price found for ${tokenKey}`);
      }
    } catch (error) {
